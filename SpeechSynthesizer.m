...
@property (copy, nonatomic) RCTResponseSenderBlock stopCallback;
@end
...
// Returns true when sound is stopped
RCT_EXPORT_METHOD(isStopped:(RCTResponseSenderBlock)callback)
{
